...
>(
  (
    ...
    if (!hasMounted) {
      // Render desktop structure server-side and on initial client render
      // as useIsMobile() will return false initially.
      return (
        <div
          ref={ref}
    ...
    // After mounting, use the actual isMobile value
    if (isMobile) {
      return (
    ...
    // Desktop rendering (same as the !hasMounted case for collapsible)
    return (
      <div
        ref={ref}
        className="group peer hidden md:block text-sidebar-foreground"
